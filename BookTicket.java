...
public class BookTicket {
    ...
    public static void book(Flight currentFlight, int tickets, int passengerID) {
        ...
        passengerDetail = "Pssenger ID" + passengerID + "--" + " Number of Tickets Booked " + tickets + "--"
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                // cancel
                case 2: {
                    System.out.println("enter flight id and passenger id to cancel");
                    int fid = sc.nextInt();
